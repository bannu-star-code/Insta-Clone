...
# SECRET_KEY = 'django-insecure-3o0*f0stef1o7h6)498-8*dwn^x^((*3*&b%a(l0v)83k*(e&r'
...
# EMAIL_HOST_USER = 'nitinchiliveri@gmail.com'
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '_0f1=iohjx%z)$u74j08b(s%$8bpu9!pl6=4e#q^0t24*au*-m'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        # 'DIRS': [],
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #to change loc of template from app to base dir globally
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
...
EMAIL_USE_TLS = True
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_HOST_USER = 'nitinchiliveri007@gmail.com'
# EMAIL_HOST_PASS = ''
